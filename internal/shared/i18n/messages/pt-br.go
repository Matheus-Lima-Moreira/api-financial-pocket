...
var ptBR = []*goi18n.Message{
	...
	{ID: "token.verify_email_send_failed", Other: "Falha ao enviar email de verificação"},
	{ID: "auth.email_not_verified", Other: "Email ainda não verificado"},
	{ID: "token.resend_verification_email_success", Other: "Email de verificação enviado com sucesso"},
	{ID: "token.reset_password_email_sent_success", Other: "Email de reset de senha enviado com sucesso"},
